	...
	public static function builtin_page_load($screen){
		...
		if($screen->base == 'edit'){
			...
			if(is_post_type_viewable($screen->post_type)){
				...
				wpjam_admin('add', 'style', '#post-body #baidu_zz_section:before{content: "\f103"; color:#82878c; font: normal 20px/1 dashicons; speak: none; display: inline-block; margin-left: -1px; padding-right: 3px; vertical-align: top; -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale; }');
			}
		}
	}
